...
**/
@Configuration
@EnableJpaRepositories(basePackages = "ae.kbgroup.sapphire.dao",entityManagerFactoryRef = "entityMangerFactory",transactionManagerRef = "transactionManager")
@EnableTransactionManagement
@PropertySource(value = { "classpath:application.properties" })
public class JPAConfig {

    private static final String[] ENTITY_PACKAGES = {
            "ae.kbgroup.sapphire.domain"
    };
